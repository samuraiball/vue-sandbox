const state = {
    monsters: [
        {
            id: 1, name: 'スライム', hp: 200, didAttack: true, offensivePower: 100,
            image: 'http://img2.wikia.nocookie.net/__cb20130309185848/villains/images/0/07/Green_dragon.png'
        },
        {
            id: 2, name: 'ドラゴン', hp: 700, didAttack: true, offensivePower: 500,
            image: 'https://realdgame.jp/DQ2018/img/gacha_real_hint_chara_1.png'
        },
        {
            id: 3, name: 'ゴブリン', hp: 300, didAttack: true, offensivePower: 200,
